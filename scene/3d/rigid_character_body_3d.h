#ifndef RIGIDCHARACTERBODY_H
#define RIGIDCHARACTERBODY_H
...
VARIANT_ENUM_CAST(RigidCharacterBody3D::MotionMode);
VARIANT_ENUM_CAST(RigidCharacterBody3D::PlatformOnLeave);
